...
task("clf-deploy-consumer", "Deploys the FunctionsConsumer contract")
  ...
  .setAction(async taskArgs => {
    ...
    console.log(
      `\nWaiting ${networks[network.name].confirmations} blocks for transaction ${consumerContract.deployTransaction.hash} to be confirmed...`,
    );
