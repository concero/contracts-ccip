...
contract DEXMock2 {
    ...
    // function exactInput(ISwapRouter02.ExactInputParams calldata params) external payable returns(uint256 amountOut){
    //     (address tokenIn, address tokenOut) = abi.decode(params.path, (address,address));
    ...
    //        IRouter.Route[] _routes,
    //        address to,
    //        uint256 deadline
    //    ) external {
    //        IRouter.Route[] memory route = new IRouter.Route[](_routes.length);
    //        route = _routes;
    //
