...
contract CFunctions is FunctionsClient, ConfirmedOwner {
    ...
    function addUnconfirmedTX(bytes32 txHash, address sender, address recipient, uint256 amount, address token) external {
        ...
        transactions[txHash] = Transaction(sender, recipient, amount, token, false);
