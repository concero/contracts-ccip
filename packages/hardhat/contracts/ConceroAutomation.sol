...
//             IParentPool.WithdrawRequest memory withdrawalRequest =
//                 IParentPool(i_masterPoolProxy).getWithdrawalRequestById(withdrawalId);
...
//         IParentPool.WithdrawRequest memory withdrawalRequest =
//             IParentPool(i_masterPoolProxy).getWithdrawalRequestById(_withdrawalId);
