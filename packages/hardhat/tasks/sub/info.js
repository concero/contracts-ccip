...
(0, config_2.task)("clf-sub-info", "Gets the Functions billing subscription balance, owner, and list of authorized consumer contract addresses")
    ...
    const linkTokenAddress = CNetworks_2.default[name].linkToken;
    const functionsRouterAddress = CNetworks_2.default[name].functionsRouter;
    const sm = new functions_toolkit_2.SubscriptionManager({ signer, linkTokenAddress, functionsRouterAddress });
    await sm.initialize();
